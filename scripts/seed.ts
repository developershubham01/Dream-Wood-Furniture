...
async function main() {
  ...
  // ── Categories ──
  const categories = [
    { name: "Living Room", slug: "living-room", image: "/images/cat-living.png", sortOrder: 1, description: "Sofas, accent chairs and statement pieces that anchor your living space." },
    { name: "Sofas", slug: "sofas", image: "/images/cat-sofas.png", sortOrder: 2, description: "Fabric, leather and sectional sofas crafted for everyday comfort." },
    { name: "Beds", slug: "beds", image: "/images/cat-beds.png", sortOrder: 3, description: "Solid wood beds with upholstered and woven headboards." },
    { name: "Wardrobes", slug: "wardrobes", image: "/images/cat-wardrobes.png", sortOrder: 4, description: "Spacious wardrobes with mirror panels and smart storage." },
    { name: "Dining Room", slug: "dining-room", image: "/images/cat-dining.png", sortOrder: 5, description: "Dining tables and chairs that bring people together." },
    { name: "TV Units", slug: "tv-units", image: "/images/cat-tv.png", sortOrder: 6, description: "Wall-mounted and console TV units for tidy media walls." },
    { name: "Coffee Tables", slug: "coffee-tables", image: "/images/cat-coffee.png", sortOrder: 7, description: "Sculptural centre tables in wood and stone." },
    { name: "Study Tables", slug: "study-tables", image: "/images/cat-study.png", sortOrder: 8, description: "Desks and work-from-home setups that stay organised." },
    { name: "Custom Furniture", slug: "custom-furniture", image: "/images/cat-custom.png", sortOrder: 9, description: "Made-to-measure furniture designed around your space." },
  ];

  for (const c of categories) {
    await db.category.upsert({
      where: { slug: c.slug },
      update: { name: c.name, image: c.image, description: c.description, sortOrder: c.sortOrder },
